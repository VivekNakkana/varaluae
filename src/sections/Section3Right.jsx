  ...
  return (
    <div div className='flex gap-10 lg:gap-0 flex-col-reverse lg:flex-col items-center' >
        ...
        <div className='border-[1px] border-varal-blue/50 w-[25rem] rounded-xl p-10'>
            ...
            <div  className='text-varal-blue text-xl gap-1 flex items-center' >Learn more <img className='w-4 ' src={require('../Assets/Vector.png')} /> </div>
        </div>
        <div className='font-body flex items-center lg:items-srart lg:text-start text-center flex-col '>
            ...
            <div  className='text-varal-blue text-xl gap-1 flex items-center mt-4 '>More about our services <img className='w-4' src={require('../Assets/Vector.png')} /> </div>
        </div>
    </div>
  )
}
